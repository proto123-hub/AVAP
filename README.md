...
- 설계 전문: [docs/AVAP_DESIGN_REVIEW.md](docs/AVAP_DESIGN_REVIEW.md)
- Two-Track: 자매 프로젝트 VSGP(회사용, 동결 보존)의 사고 이력에서 도출된 설계 법칙 L1~L7을 테스트로 강제한다.
...
다음: Phase 0.5(실사 사전 조사 — 로딩 오차 분포·앵커 스크리닝, 대상 Pos6·Pos1) → Phase 1(정렬 엔진).
