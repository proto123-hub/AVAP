...
마지막 ROI ∩은 방어용이다 — 볼록 ROI는 CLOSE로 자기 경계 밖으로 자랄 수 없어 무발동이지만
(무작위 400회 유출 0건), 오목 ROI에서는 두 조각을 잇는 다리가 오목 코너 바깥을 지난다
(400회 중 5건). `rect_golden`이 회전 사각형인 현재는 전자에 해당하나, ROI 형상이 확장되면
곧바로 필요해진다.
